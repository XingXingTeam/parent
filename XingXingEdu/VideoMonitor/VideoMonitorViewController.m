...
- (void)createFootTable{
    ...
    self.schoolTypeCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(0, 2, 145, 30)];
...
//    [self.schoolTypeCombox.textField addObserver:self forKeyPath:@"text" options:NSKeyValueObservingOptionNew context:nil];
    ...
    UITextField *timeTextField =[HHControl createTextFieldWithFrame:CGRectMake(290, 2, kWidth-292, 30) placeholder:@"剩余时间" passWord:NO leftImageView:nil rightImageView:nil Font:12];
    ...
    self.classTypeCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(145, 2, 145, 30)];
