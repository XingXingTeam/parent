...
- (void)viewDidLoad {
    ...
    [self setupChildVc:[[ViewController alloc] init] title:@"圈子" image:@"圈子icon48x48" selectedImage:@"圈子（H01）icon48x48"];
    
    [self setupChildVc:[[ClassRoomHomePageViewController alloc] init] title:@"猩课堂" image:@"Classicon48x48" selectedImage:@"猩课堂(H01)icon48x48"];
