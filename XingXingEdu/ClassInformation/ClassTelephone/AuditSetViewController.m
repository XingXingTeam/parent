...
//    NSLog(@"%@-----%@-----", _action_nameStr, _action_numStr);
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"other_xid": _XIDStr, @"action_name":_action_nameStr, @"action_num":_action_numStr};
