        ...
        if([[NSString stringWithFormat:@"%@",dict[@"code"]]isEqualToString:@"1"] )
        {
            ...
            if (dataArr.count!=0) {
                for (int i=0; i<dataArr.count; i++) {
                    ...
                    [classMArr  addObject:[dataArr[i] objectForKey:@"class"]];
                    ...
                    [gradeMArr addObject:[dataArr[i] objectForKey:@"grade"]];
...
//        x =[NSString stringWithFormat:@"%@",data_end_tmMArr[indexPath.row]].integerValue;
//        NSDate *confromTimesp = [NSDate dateWithTimeIntervalSince1970:x];
//        confromTimespStr = [fomatter stringFromDate:confromTimesp];
//        cell.time.text = [NSString stringWithFormat:@"%@",confromTimespStr];
