...
//    NSLog(@"ooooooooo%@", _babyId);
    ...
    NSDictionary *params = @{@"appkey":@"U3k8Dgj7e934bh5Y", @"backtype":@"json", @"xid":@"18884982", @"user_id":@"1", @"user_type":@"1", @"baby_id":_babyId};
...
//        //路径
        ...
        NSDictionary *params = @{@"appkey":@"U3k8Dgj7e934bh5Y", @"backtype":@"json", @"xid":@"18884982", @"user_id":@"1", @"user_type":@"1", @"baby_id":_babyId, @"nickname":_nicknameTextField.text, @"personal_sign":_personal_signTextField.text, @"pdescribe":_myTextView.text};
