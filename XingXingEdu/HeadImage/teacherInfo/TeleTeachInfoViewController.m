...
//    underButton.backgroundColor = [UIColor blueColor];
    ...
    talkBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/16 +3 ,30,25);
    ...
    talkBtn.titleEdgeInsets = UIEdgeInsetsMake(20, -talkBtn.titleLabel.bounds.size.width - 30, 0, 0);
    ...
    lookBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/16 + 3,30,25);
    ...
    lookBtn.titleEdgeInsets = UIEdgeInsetsMake(20, -lookBtn.titleLabel.bounds.size.width - 30, 0, 0);
    ...
    shareBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/16 + 3,30,25);
    ...
    shareBtn.titleEdgeInsets = UIEdgeInsetsMake(20, -shareBtn.titleLabel.bounds.size.width - 30, 0, 0);
    ...
    reportBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/16 + 3,30,25);
    ...
    reportBtn.titleEdgeInsets = UIEdgeInsetsMake(20, -shareBtn.titleLabel.bounds.size.width - 30, 0, 0);
