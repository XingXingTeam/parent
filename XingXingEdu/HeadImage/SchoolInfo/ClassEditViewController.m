...
- (void)createProvinceCombox{
    self.provinceCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(100+(80+10)*0, 70, 80, 30)];
...
- (void)createCityCombox{
    ...
    self.cityCombox = [[WJCommboxView alloc]initWithFrame:CGRectMake(100+(80+10)*1, 70, 80, 30)];
...
- (void)createAreaCombox{
    ...
    self.areaCombox = [[WJCommboxView alloc]initWithFrame:CGRectMake(100+(80+10)*2, 70, 80, 30)];
...
- (void)createSchoolTypeCombox{
    ...
    self.schoolTypeCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(100, 132, 260, 30)];
...
//    self.schoolNameArr = [[NSArray alloc]initWithObjects:@"华高小学",@"希望中学",@"北京大学",@"清华大学",nil];
    ...
    self.schoolNameCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(100, 194, 260, 30)];
...
//    self.gradeNameArr = [[NSArray alloc]initWithObjects:@"小班",@"中班",@"大班",@"一年级",@"二年级",@"三年级",@"四年级",@"五年级",@"六年级",nil];
    ...
    self.gradeNameCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(100, 256, 120, 30)];
...
//    self.classNameArr = [[NSArray alloc]initWithObjects:@"1班",@"2班",@"3班",@"4班",@"5班",@"6班",nil];
    self.classNameCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(240, 256, 120, 30)];
...
//    self.auditPeopleArr = [[NSArray alloc]initWithObjects:@"张老师",@"王老师",@"李老师",@"平台审核",nil];
    ...
    self.auditNameCombox = [[WJCommboxView alloc] initWithFrame:CGRectMake(100, 318, 230, 30)];
...
//    self.auditNameCombox.dataArray = self.auditPeopleArr;
    ...
    UIButton *btn = [HHControl createButtonWithFrame:CGRectMake(335, 168, 30, 330) backGruondImageName:@"" Target:self Action:@selector(tip:) Title:@"?"];
