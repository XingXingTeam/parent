...
#define SendButtonColor [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]
...
//    [[NSNotificationCenter defaultCenter] removeObserver:self forKeyPath:InputViewObserveKeyPath];
...
-(void) initView
{
    ...
    if (_sendButton == nil) {
        ...
        [_sendButton setTitleColor:UIColorFromRGB(0, 174, 52) forState:UIControlStateNormal];
