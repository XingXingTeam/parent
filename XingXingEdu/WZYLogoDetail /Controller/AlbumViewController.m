...
//    NSLog(@"%@", _dataArray);
//    
//    NSLog(@"%@", _good_numArray);
    
    photoBrowseVC.imageName =self.imageArray[indexPath.section];
    photoBrowseVC.i =self.imageArray.count;
    photoBrowseVC.index = indexPath.row;
    photoBrowseVC.imageA = self.imageArray;
    
    photoBrowseVC.goodNMArr = _good_numArray;
    photoBrowseVC.idMArr = _idArray;
