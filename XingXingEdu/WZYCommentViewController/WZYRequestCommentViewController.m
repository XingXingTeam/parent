...
//    NSLog(@"aaaa///////////class_idStr----%@; schoolIdStr------%@", class_idStr, schoolIdStr);
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":XID, @"user_id":USER_ID, @"user_type":USER_TYPE, @"school_id":schoolIdStr ,@"class_id":class_idStr };
...
//        NSLog(@"请求 点评 --  rrrrr%@", responseObj);
        ...
        /*
         ...
         teacher = [
         {
         head_img = http://www.xingxingedu.cn/Public/app_upload/text/teacher/5.jpg,
         id = 5,
         tname = 董璐梅,
         teach_course = 英语,
         head_img_type = 1
         ...
         {
         head_img = app_upload/text/teacher/6.jpg,
         id = 6,
         tname = 夏雨荷,
         teach_course = 英语,
         head_img_type = 0
