...
- (void)loadNewData{
    ...
    NSString *Xid = [DEFAULTS objectForKey:@"RCUserId"];
...
- (void)initUI{
    ...
    headArr =[NSArray arrayWithObjects:@"ID40x40@2x",@"昵称40x44@2x",@"姓名40x40@2x",@"年龄40x46@2x",@"关系40x46@2x",@"联系方式40x40@2x",@"邮箱40x40@2x",nil];
...
//    UIButton *gradeBtn=[UIButton buttonWithType:UIButtonTypeRoundedRect];
//    [gradeBtn setFrame:CGRectMake(220 * kWidth / 375, 43 * kWidth / 375, 40 * kWidth / 375, 18 * kWidth / 375)];
//    [gradeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//    [gradeBtn setBackgroundImage:[UIImage imageNamed:@"等级big(1)60x28@2x"] forState:UIControlStateNormal];
//    [imageView addSubview:gradeBtn];
