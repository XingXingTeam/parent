...
#import "CodeDingUtil.h"

@implementation CodeDingUtil
...
{
    [CodeDingUtil showTipsWithView:inView labelText:labelText showTime:1.5];
}
...
//时间戳转时间
+(NSString *)timestampToTimeWith:(NSString *)timestamp{
