 ...
 */
    ...
    NSDictionary *params = @{@"appkey":APPKEY, @"backtype":BACKTYPE, @"xid":parameterXid, @"user_id":parameterUser_Id, @"user_type":USER_TYPE, @"album_id":[NSString stringWithFormat:@"%@", _albumID]};
