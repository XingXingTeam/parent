//
//  ClassRoomOrderDidPayTableViewController.m
//  XingXingEdu
//
...
@interface ClassRoomOrderDidPayTableViewController (){
...
@implementation ClassRoomOrderDidPayTableViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:nib forCellReuseIdentifier:@"ClassRoomOrderDidPaycell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ClassRoomOrderNoPayTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ClassRoomOrderDidPaycell"];
    if(cell==nil){
        cell=[[ClassRoomOrderNoPayTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ClassRoomOrderDidPaycell"];
    }
