//
//  ClassRoomOrderNoAppraiseTableViewController.m
//  XingXingEdu
//
...
@interface ClassRoomOrderNoAppraiseTableViewController (){
...
@implementation ClassRoomOrderNoAppraiseTableViewController
...
- (void)viewDidLoad {
    ...
    [self.tableView registerNib:nib forCellReuseIdentifier:@"ClassRoomOrderNoAppraisecell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ClassRoomOrderNoPayTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"ClassRoomOrderNoAppraisecell"];
    if(cell==nil){
        cell=[[ClassRoomOrderNoPayTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ClassRoomOrderNoAppraisecell"];
    }
