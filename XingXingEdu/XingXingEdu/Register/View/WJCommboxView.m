...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        //右边图片
        UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(- 5, 0, 15,10)];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    frame.size.height = 0;
    self.listTableView.frame = frame;
    if ([_delegate respondsToSelector:@selector(sendSelectCellNum:)]) {
        [_delegate sendSelectCellNum:indexPath.row];
    }
