...
- (void)viewDidLoad{
        ...
        vc1.title = @"机构简介";
        UIImage *normalImage1 = [UIImage imageNamed:@"机构简介icon48x48"];
      normalImage1 =  [normalImage1 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        UIImage *seletedImage1 = [UIImage imageNamed:@"机构简介(H01)icon48x48"];
    ...
    UINavigationController *nav1 = [[UINavigationController alloc] initWithRootViewController:vc1];
        ...
        vc2.title = @"学校课程";
        UIImage *normalImage2 = [UIImage imageNamed:@"学校课程icon48x48"];
       normalImage2 = [normalImage2 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        UIImage *seletedImage2 = [UIImage imageNamed:@"学校课程(H01)icon48x48"];
      seletedImage2 =  [seletedImage2 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        ...
        vc3.title = @"校长致辞";
        UIImage *normalImage3 = [UIImage imageNamed:@"校长致辞icon48x48"];
       normalImage3 = [normalImage3 imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        UIImage *seletedImage3 = [UIImage imageNamed:@"校长致辞(H01)icon48x48"];
