...
//    [[UIButton alloc] initWithFrame:];
    ...
    nextButton = [HHControl createButtonWithFrame:CGRectMake(buttonX, buttonY, buttonW, buttonH) backGruondImageName:@"login_green" Target:self Action:@selector(nextButtonClick:) Title:@"下一步"];
