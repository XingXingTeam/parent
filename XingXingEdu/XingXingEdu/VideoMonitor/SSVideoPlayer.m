...
//
#define urlHttp @"http://"
#define urlHttps @"https://"
#define ktStatus @"status"
#define ktLoadedTimeRanges @"loadedTimeRanges"
#import "SSVideoPlayer.h"
#import <AVFoundation/AVFoundation.h>

static NSString *const SSVideoPlayerItemStatusKeyPath = ktStatus;
static NSString *const SSVideoPlayerItemLoadedTimeRangesKeyPath = ktLoadedTimeRanges;
...
- (void)setPath:(NSString *)path {
    ...
    if ([p hasPrefix:urlHttp] || [p hasPrefix:urlHttps]) {
