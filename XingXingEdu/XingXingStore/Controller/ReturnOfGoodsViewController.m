...
-(void)returnOfGoodsView{
    ...
    NSArray *relationArray = [[NSArray alloc]initWithObjects:@"有退货",@"无退货",nil];
    ...
    [mgr POST:urlStr parameters:dict success:^(AFHTTPRequestOperation *operation, id responseObject)
     {
         ...
         {
//             SubjectOrderListViewController *SubjectOrderListVC = [[SubjectOrderListViewController alloc] init];
//             SubjectOrderListVC.LeftButton = YES;
