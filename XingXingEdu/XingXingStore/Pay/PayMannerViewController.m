...
-(void)createBuydetailMessage{
    ...
    for (int i = 0; i < imageNameArr.count; i ++) {
        ...
        if (i == 0) {
            ...
            UILabel *sayXblabel = [HHControl createLabelWithFrame:CGRectMake(CGRectGetMaxX(imageNameView.frame) + Kmgar, CGRectGetMaxY(xingbiLabel.frame), kWidth - 130, KlabelH) Font:10 Text:[NSString stringWithFormat:@"您的剩余猩币总数:%@ （每100猩币可抵扣1元）",_user_coin_able]];
        ...
        if (i == 1) {
            ...
            UILabel *sayWclabel = [HHControl createLabelWithFrame:CGRectMake(CGRectGetMaxX(imageNameView.frame) + Kmgar, CGRectGetMaxY(weiChatLabel.frame), KlabelWL, KlabelH) Font:10 Text:@"推荐安装微信5.0以上的用户使用"];
        ...
        if (i == 2) {
            ...
            UILabel *sayAllabel = [HHControl createLabelWithFrame:CGRectMake(CGRectGetMaxX(imageNameView.frame) + Kmgar, CGRectGetMaxY(alipayLabel.frame), KlabelWL, KlabelH) Font:10 Text:@"推荐有支付宝账号的用户使用"];
