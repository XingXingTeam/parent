...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message  picImage:(NSString *)imageName sureBtn:(NSString *)sureBtn cancleBtn:(NSString *)cancleBtn{
    if (self == [super init]) {
        ...
        if (title) {
            self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(- 20, LAVSPACE *4, LAVWIDTH, 20)];
        ...
        if (imageName) {
            ...
            self.picImgae = [[UIImageView alloc] initWithFrame:CGRectMake(20, LAVSPACE *3, 60, 60)];
        ...
        if (message) {
            ...
            self.mesLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.picImgae.frame) + 20, CGRectGetMaxY(self.titleLabel.frame)+LAVSPACE, LAVWIDTH-60, mesHeight)];
