...
-(void)createTextFields{
    ...
    //合计
    UILabel *label = [HHControl createLabelWithFrame:CGRectMake(bgView.size.width/2 + KWide , KMarg, LabelW , TextFieldAndLabelH ) Font:14 Text:@"合计:"];
    label.textColor = [UIColor blackColor];
    label.textAlignment=NSTextAlignmentRight;
    
    _price = [HHControl createLabelWithFrame:CGRectMake(label.x + label.size.width +KMarg,KMarg,LabelW ,TextFieldAndLabelH) Font:14 Text:_infoData[0]];
    ...
    priceLabel = [HHControl createTextFielfFrame:CGRectMake(bgView.size.width/2 - 30, label.y + label.size.height + 17,LabelW + KMarg*2, TextFieldAndLabelH) font:[UIFont systemFontOfSize:10] placeholder:@"输入兑换币数目"];
    ...
    deductionL=[[UITextField alloc]initWithFrame:CGRectMake(bgView.size.width - 160, label.y + label.size.height + 18, LabelW * 2,TextFieldAndLabelH )];
    deductionL.userInteractionEnabled = NO;
    
    NSString *longStr = [NSString stringWithFormat:@"个猩币可抵扣%d元",[priceLabel.text intValue]/100];
    ...
    deductionL.textAlignment=NSTextAlignmentRight;
    deductionL.font=[UIFont systemFontOfSize:10];
    [bgView addSubview:deductionL];
    
    //实付
    UILabel *actuallyPaidLabel = [HHControl createLabelWithFrame:CGRectMake(bgView.size.width/2 + KWide, deductionL.y + deductionL.size .height + 16, LabelW , TextFieldAndLabelH) Font:14 Text:@"实付:"];
    ...
    actuallyPriceLabel.text = [NSString stringWithFormat:@"%d",[_infoData[0] intValue]];
...
-(void)postSubjectBuyInfo{
    ...
    NSDictionary *dict = @{@"appkey":APPKEY,
                           ...
                           @"deduct_price":[NSString stringWithFormat:@"%d",[priceLabel.text intValue]/100],
...
-(void)clickbtn:(UIButton *)btn{
    if (isCollect==NO) {
        ...
        actuallyPriceLabel.text = [NSString stringWithFormat:@"%d",[_infoData[0] intValue]*[textStr intValue]];
        [priceLabel setText:@""];
...
- (void)textFieldDidEndEditing:(UITextField *)textField{
    ...
    if (textField.tag == 1) {
        ...
        if ([textStr intValue] > 4) {
            ...
            //合计
            _price.text = [NSString stringWithFormat:@"%d",[_infoData[0] intValue]*[textStr intValue]];
            actuallyPriceLabel.text = [NSString stringWithFormat:@"%d",[_infoData[0] intValue]*[textStr intValue]];
...
//        _babyName = [NSString stringWithFormat:@"%@,%@,%@,%@",_babyName1,_babyName2,_babyName3,_babyName4];
    ...
    if (textField.tag == 10000) {
        int intString = [textField.text intValue];
        NSInteger colorRange = 0;
        
        if(intString > [_infoData[4] intValue]){
        ...
        NSString *longStr = [NSString stringWithFormat:@"个猩币可抵扣 %d 元",intString/100];
        NSMutableAttributedString *str = [[NSMutableAttributedString alloc] initWithString:longStr];
        ...
        if (isCollect) {
            //合计
            int a = intString/100;
            int b = [_infoData[0] intValue];
            if (a > b * [textStr intValue]) {
                ...
                int c = b * [textStr intValue] - a;
                actuallyPriceLabel.text = [NSString stringWithFormat:@"%d",c];
            }
            //实付
