...
-(void)scrollViewUI{
    ...
    CGFloat maxH =  CGRectGetMaxY(scrollView.frame) + 300;
...
-(void)butttomBtn {
    ...
    talkBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/8 - 10,30,25);
    ...
    shareBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/8 - 10,30,25);
    ...
    _buyBtn.imageEdgeInsets = UIEdgeInsetsMake(5,kWidth/8 - 10,30,25);
    ...
    _buyBtn.titleEdgeInsets = UIEdgeInsetsMake(20, -_buyBtn.titleLabel.bounds.size.width - 30, 0, 0);
